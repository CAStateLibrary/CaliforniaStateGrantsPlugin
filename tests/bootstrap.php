...
if ( ! defined( 'CSL_GRANTS_SUBMISSIONS_DIR' ) ) {
	define( 'CSL_GRANTS_SUBMISSIONS_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'CSL_GRANTS_SUBMISSIONS_PATH' ) ) {
	define( 'CSL_GRANTS_SUBMISSIONS_PATH', 'path' );
}
